...
#define CLEAR_SCREEN_COLOR WHITE_ON_BLACK
#define CMD_COLOR GRAY_ON_BLACK
#define OUTPUT_COLOR LIGHTCYAN_ON_BLACK
#define CMD_PROMPT_COLOR LIGHTGREEN_ON_BLACK
