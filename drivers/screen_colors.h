...
#define DEFAULT_COLOR BRIGHTWHITE_ON_BLACK
#define ERROR_COLOR_1 LIGHTRED_ON_BLACK
#define ERROR_COLOR_2 RED_ON_BRIGHTWHITE
#define CLEAR_SCREEN_COLOR GRAY_ON_BLACK
#define CMD_COLOR WHITE_ON_BLACK
#define OUTPUT_COLOR WHITE_ON_BLACK
#define CMD_PROMPT_COLOR GREEN_ON_BLACK
#define VAR_COLOR LIGHTGREEN_ON_BLACK
